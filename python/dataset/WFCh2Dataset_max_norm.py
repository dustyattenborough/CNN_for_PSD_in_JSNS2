...
#### normalize data by wave maximum value 
...
class WFCh2Dataset_max_norm(Dataset):
    def __init__(self, **kwargs):
        super(WFCh2Dataset_max_norm, self).__init__()
        self.isLoaded = False
        self.fNames = []
...
#             weights = torch.ones(nEvents, dtype=torch.float32, requires_grad=False)*weight*weight_z
