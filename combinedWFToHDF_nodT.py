...
out_dT = np.array(tComb['Var1'].array())

CorRV = np.array(tComb['CorRecoVertex'].array())
RV = np.array(tComb['RecoVertex'].array())

out_dVertex = np.sqrt(np.power(CorRV-RV,2).sum(axis=1))
